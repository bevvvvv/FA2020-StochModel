...
\[\pi_j = \pi_jP_{jj} + \pi_iP_{ij}\]
\[\pi_j = \pi_j\frac{v_j}{(v_i+v_j)} + (1-\pi_j)\Sigma_i\frac{v_i}{(v_i+v_j)}\]
\[\pi_j = \pi_j\frac{v_j}{(v_i+v_j)} + \Sigma_i\frac{v_i}{(v_i+v_j)} - \Sigma_i\frac{\pi_jv_i}{(v_i+v_j)}\]
...
\[P(T > \frac12) = F(\frac12) = 1-e^{-1} \approx 0.6321\]

## Part b

Here we can apply the memoryless property:

\[P(T > 12 + \frac12 | T > 12) = P(T>\frac12) \approx 0.6321\]
